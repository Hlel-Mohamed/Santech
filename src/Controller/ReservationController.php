...
class ReservationController extends AbstractController
{
    ...
    public function index(Request $request, ScheduleRepository $scheduleRepository, UsersRepository $usersRepository)
    {
        ...
        return $this->render('patient/index.html.twig', [
            'datenull' => $datenull ?? null,
        ]);
    }

    #[Route('/booking/{id}', name: 'booking')]
    public function booking(Schedule $schedule, Request $request, EntityManagerInterface $entityManager): RedirectResponse
    {
    ...
    public function testModal(Request $request, UsersRepository $UserRepository): Response
    {
